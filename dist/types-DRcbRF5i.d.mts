...
type CliOptions<Parameters extends string[] = string[]> = ParametersOrCommands<Parameters> & {
...
export { footer as f, cmds as g, flags as h, flagsInline as i, flagsHanging as j, p, section as s, usage as u };
export type { CliOptions as C, DescribedDefault as D, ExitReason as E, Flags as F, HelpOptions as H, Node as N, ParsedArgv as P, StrictOptions as S, CallbackFunction as a, CommandEntry as b, Commands as c, HelpRenderer as d, HelpForm as e, Flag as k };
